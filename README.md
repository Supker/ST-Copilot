...
* **Session History Depth:** The number of recent roleplay messages the Copilot will read to understand the immediate context (adjustable via the slider in the Copilot window as well).
